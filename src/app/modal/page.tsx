...
export default function ModalPage() {
    ...
    return (
        <div className="fixed w-full h-screen flex items-center justify-center overflow-y-auto">
            <div className="w-[420px] bg-profileCardBg py-6 rounded-xl">
                <div className="px-4">
                    <div className="flex justify-end">
                        <Image src={cancelLogo} alt="Close"/>
                    </div>
